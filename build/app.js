...
angular.module('app.biz').controller('BrandCompetitionController', function () {
    var vm = this;
    ...
    vm.data2 = {
        ...
        yAxis: {reversedStacks: false, gridLineColor: 'transparent', min: 0, title: {text: 'TOTAL'}},
...
angular.module('app.biz').controller('CampaignBreakdownController', function () {
    var vm = this;
...
angular.module('app.biz').controller('OpportunityController', function () {
    var vm = this;
    vm.labels = ['Think BIG', 'Friendship', 'We are'];
...
angular.module('app.biz').controller('InvoiceController', function ($state) {
    var vm = this;
});
'use strict';
...
angular.module('app.biz').controller('SocialLinkedinController', function ($state, $filter, SocialPages) {
    ...
    vm.tabs = [
        ...
        {title: 'Insights', state: 'socialLinkedin.insights'}
    ];
...
angular.module('app.biz').controller('SocialTwitterController', function ($state, $filter, SocialPages) {
    ...
    vm.tabs = [
        ...
        {title: 'Insights', state: 'socialTwitter.insights'}
    ];
...
angular.module('app.biz').controller('GoogleplusInsightsController', function ($state) {
    var vm = this;
    vm.go = function (state) {
        $state.go('app.biz.' + state);
    };
...
angular.module('app.biz').controller('LinkedinInsightsController', function ($state) {
    var vm = this;
    vm.go = function (state) {
        $state.go('app.biz.' + state);
    };
