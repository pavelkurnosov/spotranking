...
angular.module('app.biz').controller('FacebookInsightsController', function () {
    var vm = this;
...
angular.module('app.biz').controller('InstagramInsightsController', function () {
    var vm = this;
...
angular.module('app.biz').controller('PinterestInsightsController', function () {
    var vm = this;
...
angular.module('app.biz').controller('TwitterInsightsController', function () {
    var vm = this;
